...
<header id="header" class="header fixed-top d-flex align-items-center">
  <div class="d-flex align-items-center justify-content-between"> <a href="{{ route('maindashboard') }}" class="logo d-flex align-items-center">  <span class="d-none d-lg-block"><span style="color:red">BY<span style="color:rgb(255, 230, 0)">T</span></span>ECOMMERCE</span> </a> <i class="bi bi-list toggle-sidebar-btn"></i></div>
