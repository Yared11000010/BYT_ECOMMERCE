<aside id="sidebar" class=" colored sidebar " >
  <ul class="sidebar-nav" id="sidebar-nav">
     ...
     <li class="nav-item {{ request()->is('admin/section*')?'':'collapsed' }}  {{ request()->is('admin/categories*')?'':'collapsed' }} {{ request()->is('admin/groups*')?'':'collapsed' }} {{ request()->is('admin/subcategories*')?'':'collapsed' }}{{ request()->is('admin/brands*')?'':'collapsed' }}">
      ...
      <ul id="charts-nav" class="nav-content collapse {{ request()->is('admin/subcategories*')?'show':'' }} {{ request()->is('admin/section*')?'show':'' }} {{ request()->is('admin/categories*')?'show':'' }} {{ request()->is('admin/groups*')?'show':'' }} {{ request()->is('admin/brands*')?'show':'' }}" data-bs-parent="" style="">
         ...
         <li> <a href="{{ route('brands') }}" class=" {{ request()->is('admin/brand*')?' nav-link active':'' }}"> <i class="bi bi-circle"></i><span>Brand</span> </a></li>
      </ul>
     </li>
