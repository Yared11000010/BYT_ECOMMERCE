<aside id="sidebar" class=" colored sidebar " >
  <ul class="sidebar-nav" id="sidebar-nav">
     ...
     <li class="nav-item">
      <a class="nav-link {{ request()->is('admin/section')?'':'collapsed' }}" data-bs-target="#charts-nav" data-bs-toggle="collapse" href="#" aria-expanded="false"> <i class="bi bi-bar-chart"></i><span>Catelog Managements</span><i class="bi bi-chevron-down ms-auto"></i> </a>
